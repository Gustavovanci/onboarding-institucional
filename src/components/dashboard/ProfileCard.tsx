...
// ✅ Função de proteção de imagem (mesmo princípio do RankingPage)
...
export default function ProfileCard({
  ...
  const fallbackURL = `https://ui-avatars.com/api/?name=${encodeURIComponent(user.displayName)}&size=160&background=ffffff&color=2b97d4`;
    ...
    >
      ...
      <div className="px-6 py-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          ...
          <div className="text-center">
            <div className="text-2xl font-bold text-brand-teal">#{user.currentRank || "N/A"}</div>
            <div className="text-xs text-gray-500">Ranking Geral</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-purple-600">#{user.instituteRank || "N/A"}</div>
